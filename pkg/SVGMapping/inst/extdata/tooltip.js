...
function legacyTooltip(evt,text) {
    ...
    var text_h = svg_text.getComputedTextHeight()
    var font_size = 80
    while(text_h + h_margin > h_max && font_size > 20) {
	font_size = font_size - 1
	svg_text.setAttributeNS(null,"font-size", font_size + "%")
	text_h = svg_text.getComputedTextHeight()
    }

...
test_that("Accessors", {
  ...
  expect_identical(cx(gradient), SVGCoord.factory("15pt"))
  expect_identical(cy(gradient), SVGCoord.factory("12pt"))
  expect_identical(r(gradient), SVGLength.factory("50px"))
  expect_identical(fx(gradient), SVGCoord.factory("4"))
  expect_identical(fy(gradient), SVGCoord.factory("3"))
